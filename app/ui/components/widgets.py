...
def make_badge(text: str) -> QLabel:
    ...
    badge = QLabel(text)
    object_name = STATUS_BADGE_MAP.get(text, "badge_gray")
...
class KpiCard(QFrame):
    ...
    def __init__(self, icon: str, label: str, value: str | int,
        ...
        icon_lbl.setStyleSheet(
            f"background-color: {_lighten_color(color)};"
...
def _lighten_color(hex_color: str) -> str:
    """Devuelve una versión muy clara de un color hex para los fondos de iconos."""
    color_map = {
        "#16A34A": "#DCFCE7",
        "#1E5FC3": "#DBEAFE",
        "#DC2626": "#FEE2E2",
...
def set_table_item(table: QTableWidget, row: int, col: int,
    ...
    if badge:
        ...
        layout.setAlignment(Qt.AlignmentFlag.AlignCenter if align_center else Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter)
